(function() {
    function async_load(u,id) {
        if ($('#'+id).length==0) {
            s="script", d=document, o = d.createElement(s);
            o.type = 'text/javascript'; o.id = id; o.async = true; o.src = u; x = d.getElementsByTagName(s)[0];
    ...
    window.onload = function() {
        ...
        async_load("//connect.ok.ru/connect.js", "id_odnoklassniki");//odnoklassniki.ru
        async_load("//cdn.connect.mail.ru/js/loader.js", "id_mailru");//mail.ru
    };
    // Инициализация vkontakte
    window.vkAsyncInit = function(){
        VK.init({apiId: 3740925, onlyWidgets: true});
 ...
 * jQuery plugin
 */
$.fn.socialsLike = function() {
	return this.each(function() {
		new socialsLike($(this));
	});
};


function socialsLike(container) {
	this.container = container;
	this.init();
}

socialsLike.prototype = {
	optionsMap: {
		pageUrl: {
			attr: 'url',
